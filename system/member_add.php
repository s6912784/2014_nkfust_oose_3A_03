	...
	if($row[m_acc] == $acc){
		...
		if($nme =="" and $ac =="" and $pa=="" and $eam ==""){
			...
			if($nme == 1 and $ac == 1 and $pa ==1 and $eam == 1){
				...
				echo "<script>location.replace('?a=member_login.php')</script>";
			}else{
				echo "<script>alert('註冊資料格式有錯誤!!!!')</script>";
				echo "<script>location.replace('?a=member_add.php')</script>";
			}
		}
	}
}
...
<font size="-1">
<div align="center">
<img src="admin/pic/star.png"> <font face="華康秀風體W3" size="+3" >申請會員</font>
<br><br>
